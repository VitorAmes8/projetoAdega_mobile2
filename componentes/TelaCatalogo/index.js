      ...
      <ScrollView style={ estilos.containerScroll }>
        ...
        <View style={ estilos.cardVinho }>
          ...
          <View style={ estilos.cardBoxDescricao}>
            ...
            <Text style={ estilos.cardDescricao}>Vinho encorporado, saboroso e frutado, com final levemente adocicado. Sua cor é vermelho-rubi. Perfeito com queijo parmesão e carnes assadas ou grelhadas.</Text>
          </View>
        </View>
